# p-Hash Coverage Progress

Track which sets have had p-hashes computed and loaded into the system.
Check a set off once all cards in that set have p-hashes in the database.
...
<!-- Add other games below as new H2 sections, e.g. ## Magic: The Gathering -->
